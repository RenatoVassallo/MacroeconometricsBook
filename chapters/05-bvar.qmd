...
**Requisitos previos.** @sec-var y @sec-svar; la normal multivariada y la inversa-Wishart ([sección 0.10](00-preliminares.qmd#sec-prelim-distribuciones)); el producto de Kronecker y el operador $\operatorname{vec}$ ([0.6](00-preliminares.qmd#sec-prelim-kronecker)); el muestreo de Gibbs en una dimensión ([0.12](00-preliminares.qmd#sec-prelim-bayes)).
