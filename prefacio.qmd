...
Se asume econometría de pregrado, álgebra matricial, probabilidad y algo de Python. Quien necesite refrescar cualquiera de las tres cosas encontrará en el [capítulo 0](chapters/00-preliminares.qmd) un repaso dirigido: sólo lo que el libro usa, con un ejemplo ejecutable y un enlace al capítulo donde vuelve a aparecer. No se asume experiencia previa con métodos bayesianos: el capítulo 0 cubre lo necesario para el VAR bayesiano, y el @sec-bayes, lo que piden los capítulos posteriores.
